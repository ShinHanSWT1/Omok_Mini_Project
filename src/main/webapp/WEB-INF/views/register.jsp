        ...
        <form method="post" action="${pageContext.request.contextPath}/register">
            ...
            <div class="row">
                ...
                <div class="profiles" id="profiles">
                    <img class="profile-item" src="${pageContext.request.contextPath}/assets/profiles/p1.png"
                         data-value="/assets/profiles/p1.png" alt="p1">
                    <img class="profile-item" src="${pageContext.request.contextPath}/assets/profiles/p2.png"
                         data-value="/assets/profiles/p2.png" alt="p2">
                    <img class="profile-item" src="${pageContext.request.contextPath}/assets/profiles/p3.png"
                         data-value="/assets/profiles/p3.png" alt="p3">
                    <img class="profile-item" src="${pageContext.request.contextPath}/assets/profiles/p4.png"
                         data-value="/assets/profiles/p4.png" alt="p4">
                    <img class="profile-item" src="${pageContext.request.contextPath}/assets/profiles/p5.png"
